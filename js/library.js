...
if(!page.light)icons.array=Object.values(icons.use=icons.list=await(await fetch(`${page.light?`../`:``}json/icons.json`)).json());
else if(page.light)icons.array=Object.values(icons.use=await(await fetch(`../json/light.json`)).json());
page.init();
